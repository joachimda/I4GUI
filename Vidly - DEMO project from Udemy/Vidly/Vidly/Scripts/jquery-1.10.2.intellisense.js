...
intellisense.annotate(jQuery.fn, {
  ...
  'id': function() {
    /// <signature>
    ///   <summary>Selects a single element with the given moivieId attribute.</summary>
    ///   <param name="moivieId" type="String">An ID to search for, specified via the moivieId attribute of an element.</param>
    /// </signature>
  },
  'image': function() {
